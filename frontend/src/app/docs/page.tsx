...
const DOC_CARDS = [
  {
    eyebrow: "Browsing",
    accent: "#00F2FF",
    body: "Use the category pages (DNA, RNA, Proteins, CRISPR, Viruses, Genomes), Paleogenomics, and the publication catalogue to explore records, or the global search for accessions, gene names, organisms and PMIDs. Every count shown is a live aggregate.",
  },
  {
